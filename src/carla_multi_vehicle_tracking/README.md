...
1. Carla simulator : Download Carla simulator and follow the instuction guide - https://carla.readthedocs.io/en/latest/start\_quickstart/
...
11. Run gt\_deepsort.ipynv file followed by evaluate.ipynb to generate MOTA and MOTP values
NOTE :
